<template>
  <div class="d-flex align-center">
    <span class="mr-2 v-text-body-2 text-primary-dark" v-if="displayName">{{
      $t(displayName)
    }}</span>
    <VDateSelect
    ...
    >
      ...
      <template v-slot:prepend-inner>
        <span
          ...
          class="align-self-center v-text-body-3"
        >
          -
        </span>
        <span v-else-if="selectAll" class="align-self-center v-text-body-3">
          All
        </span>
      </template>
