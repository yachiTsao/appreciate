<template>
  <div class="d-flex flex-column align-center justify-center">
    <v-chart :option="gaugeOption" :style="{ height: height, width: width }" autoresize />
    <div class="d-flex flex-column align-start justify-center ml-6">
      <v-row class="ma-0 d-flex align-center justify-start custom-legend">
        <v-sheet :color="color" width="10" height="5" class="mr-2"></v-sheet>
        <p class="v-text-body-2">{{ used }}</p>
      </v-row>
      <v-row class="ma-0 d-flex align-center justify-start custom-legend">
        <v-sheet color="fourth" width="10" height="5" class="mr-2"></v-sheet>
